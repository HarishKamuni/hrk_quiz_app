      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl">
            ...
            <div className="text-2xl font-bold text-purple-600 mb-2">5:00</div>
          ...
          <div className="text-left bg-gray-50 p-6 rounded-xl max-w-2xl mx-auto">
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start">
                <span className="shrink-0 w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center text-sm font-semibold mr-3 mt-0.5">
                  1
                </span>
